    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('query_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='spectral_indices.ResultType')),
        ...
        migrations.AlterUniqueTogether(
            name='spectralindicestask',
            unique_together=set([('satellite', 'area_id', 'time_start', 'time_end', 'latitude_max', 'latitude_min', 'longitude_max', 'longitude_min', 'title', 'description', 'compositor', 'query_type')]),
        ),
    ]
