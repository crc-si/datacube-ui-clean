    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('animated_product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='custom_mosaic_tool.AnimationType')),
        ...
        migrations.AddField(
            model_name='custommosaictooltask',
            name='query_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='custom_mosaic_tool.ResultType'),
        ),
        migrations.AddField(
            model_name='custommosaictooltask',
            name='satellite',
        ...
        migrations.AlterUniqueTogether(
            name='custommosaictooltask',
            unique_together=set([('satellite', 'area_id', 'time_start', 'time_end', 'latitude_max', 'latitude_min', 'longitude_max', 'longitude_min', 'title', 'description', 'query_type', 'animated_product', 'compositor')]),
        ),
    ]
