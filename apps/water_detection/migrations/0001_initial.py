    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fill', models.CharField(default='black', max_length=25)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('water_pixels_per_acquisition', models.CharField(default='', max_length=100000)),
                ('water_observations_path', models.CharField(default='', max_length=250)),
                ...
                ('animated_product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='water_detection.AnimationType')),
                ('query_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='water_detection.ResultType')),
